...
all : obj lib reliable_sender reliable_receiver
...
reliable_receiver: $(SERVEROBJECTS) $(BUFFEROBJECTS)
...
reliable_sender: $(CLIENTOBJECTS) 
	$(CC) $(COMPILERFLAGS) $^ obj/lib.a -o $@ $(LINKLIBS)
...
lib:
	$(CC) $(COMPILERFLAGS) -c src/lib/circular_buffer.c -o obj/lib.o
	ar cr obj/lib.a obj/lib.o
